...
public class SignatureView extends View {
    ...
    public Bitmap getSignature() {
        ...
        Bitmap signatureBitmap = Bitmap.createBitmap(this.getWidth() - 10, this.getHeight(), Bitmap.Config.RGB_565);

        // important for saving signature
        final Canvas canvas = new Canvas(signatureBitmap);
        this.draw(canvas);

        return Utilities.getInstance().rotateImage(signatureBitmap, 270);
    }
